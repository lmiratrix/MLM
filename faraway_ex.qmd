...
Code for longitudinal data Code modified version from Faraway book chapter 9 (see iPac on Canvas) See chapter to get explanations, etc. or just run code line by line to see what you get!
Note: this code uses ggplot.
Book uses another plotting package called 'lattice'
