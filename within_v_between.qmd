...
We first calculate school-average ses and then group mean center ses within school.
This makes two variables, grp_mean_ses (level 2) and grp_center_ses (level 1).
...
For students within a given school, students who are 1-unit higher in SES are predicted to score 2.19 points higher in math.
...
This looks very large, but remember that variation in school mean SES is typically much less than the variation in student ses scores.
In particular, we can calculate the standard deviation of school mean ses'es to get:
...
Check out the Raudenbush and Bryk pages on within vs. between.
Also see, if desired, read @antonakis2019a.
