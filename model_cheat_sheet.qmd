...
This handout shows a model, the `lmer` syntax, and the output for the model discussed in class in Lecture 2.4.

The model Level 1 models: $$
\begin{aligned}
...
We usually look at the correlation of \[ \rho = \frac{ \tau_{01} }{ \sqrt{ \tau_{00} \tau_{11} } } \] The estimated $\rho$ is what R gives us in the printed output.
